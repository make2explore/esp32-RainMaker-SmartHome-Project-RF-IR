// ---------------------------------- make2explore.com -------------------------------------------------------//
// Project           - ESP RainMaker + Alexa + Google Home + Manual Switch + IR & RF Remote control 8 Relays
...
#define IR_RECEIVE_PIN  35              // IR Receiver connected to pin 35
...
// Command Code of IR Remote buttons 0x<HEX CODE>
...
#define IR_Button_all_ON    0xE11E7F80
#define IR_Button_all_OFF    0xED127F80
...
void setup()
{
    ...
    mySwitch.enableReceive(34);  // Receiver on interrupt 0 => that is pin #34
